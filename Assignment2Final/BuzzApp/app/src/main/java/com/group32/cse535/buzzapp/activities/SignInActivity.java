...
import com.group32.cse535.buzzapp.receiver.CustomVolleyRequest;
import com.group32.cse535.buzzapp.R;

/**
 * Created by jaydatta on 3/19/17.
 */
...
//            signInHandler.postDelayed(returnToMainActivity,5000);
    ...
    private Runnable returnToMainActivity = new Runnable() {
        @Override
        public void run() {
            Toast.makeText(SignInActivity.this, "Returning to HomePage", Toast.LENGTH_LONG).show();
            finish();
        }
    };
